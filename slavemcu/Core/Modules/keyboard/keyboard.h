...
#include <stdint.h>
#include <stdbool.h>
// #include "local_blackboard.h"  // COMMENTED OUT FOR TESTING

// 键盘GPIO配置 - Modified for S13-S16 keys
// Row pin (input with pullup)
#define KEYBOARD_ROW_PORT       GPIOA
#define KEYBOARD_ROW_PIN        GPIO_PIN_11    // r4

// Column pins (output)
#define KEYBOARD_COL_PORT       GPIOA
#define KEYBOARD_COL1_PIN       GPIO_PIN_8     // c1 for S16
#define KEYBOARD_COL2_PIN       GPIO_PIN_12    // c2 for S15
#define KEYBOARD_COL3_PIN       GPIO_PIN_5     // c3 for S14
#define KEYBOARD_COL4_PIN       GPIO_PIN_4     // c4 for S13
...
#define KEY_NONE                0
#define KEY_S13                 13      // Floor 4 button (not used currently)
