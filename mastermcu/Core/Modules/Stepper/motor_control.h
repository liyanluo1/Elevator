...
uint8_t Motor_RunExample1(Motor_t* motor);  // 对应CAN_SENT1
uint8_t Motor_RunExample2(Motor_t* motor);  // 对应CAN_SENT2
uint8_t Motor_RunExample3(Motor_t* motor);  // 对应CAN_SENT3
